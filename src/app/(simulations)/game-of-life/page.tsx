...
const presets: {
  ...
  glider_gun: {
    ...
    fields: [
      ['0-24', 1],
      ['0-22', 1, 0, 1],
      ['0-12', '1-2', '0-6', '1-2', '0-12', '1-2'],
      ['0-11', 1, '0-3', 1, '0-4', '1-2', '0-12', '1-2'],
      ['1-2', '0-8', 1, '0-5', 1, '0-3', '1-2'],
      ['1-2', '0-8', 1, '0-3', 1, 0, '1-2', '0-4', 1, 0, 1],
      ['0-10', 1, '0-5', 1, '0-7', 1],
      ['0-11', 1, '0-3', 1],
      ['0-12', '1-2']
    ],
  ...
  '101': {
    ...
    fields: [
      ...
      ['0-3', 1, 0, 1, '0-6', 1, 0, 1],
      ['0-3', 1, '0-10', 1],
      ['1-2', 0, 1, '0-10', 1, 0, '1-2'],
      ['1-2', 0, 1, 0, 1, '0-2', '1-2', '0-2', 1, 0, 1, 0, '1-2'],
  ...
  spaceship_1: {
    ...
    fields: [
      ['0-5', 1, '0-7', 1],
      ['0-3', '1-2', 0, '1-2', '0-3', '1-2', 0, '1-2'],
      ['0-6', '1-2', '0-3', '1-2'],
      ['0-8', 1, 0, 1],
      [0, 1, '0-4', 1, 0, 1, 0, 1, 0, 1, '0-4', 1],
      ['1-3', '0-5', 1, 0, 1, '0-5', '1-3'],
      [1, '0-5', 1, 0, 1, 0, 1, 0, 1, '0-5', 1],
      ['0-2', 1, '0-2', 1, '0-2', 1, 0, 1, '0-2', 1, '0-2', 1],
      ['0-2', '1-2', '0-3', '1-2', 0, '1-2', '0-3', '1-2'],
      [1, '0-7', 1, 0, 1, '0-7', 1],
      [1, '0-6', '1-2', 0, '1-2', '0-6', 1]
    ],
    align: 'bm'
  },
  shredder: {
    ...
    fields: [
      ['0-2', '1-2', '0-5', '1-2'],
      ['0-3', '1-2', '0-3', '1-2'],
      [1, '0-2', 1, 0, 1, 0, 1, 0, 1, '0-2', 1],
      ['1-3', 0, '1-2', 0, '1-2', 0, '1-3'],
  ...
  reactor: {
    ...
    fields: [
      ...
      [],
      ['0-8', '1-2', '0-22', '1-2'],
      ['0-9', 1, '0-12', '1-2', '0-8', 1],
      ['0-9', 1, 0, 1, '0-10', 1, '0-7', 1, 0, 1],
      ['0-5', 1, '0-4', '1-2', '0-10', 1, '0-7', '1-2', '0-4', 1],
      ['0-5', '1-3', '0-15', 1, '0-10', '1-3'],
      ['0-8', 1, '0-24', 1],
      ['0-7', '1-2', '0-24', '1-2'],
      [],
      [],
      ...
      ['0-7', '1-2', '0-24', '1-2'],
      ['0-8', 1, '0-24', 1],
      ['0-5', '1-3', '0-10', 1, '0-15', '1-3'],

      ['0-5', 1, '0-4', '1-2', '0-7', 1, '0-10', '1-2', '0-4', 1],
      ['0-9', 1, 0, 1, '0-7', 1, '0-10', 1, 0, 1],
      ['0-9', 1, '0-8', '1-2', '0-12', 1],
      ['0-8', '1-2', '0-22', '1-2'],
      [],
      [],
      [],
